...
#define CONFIGURE_ARGS " '--disable-dependency-tracking' '--prefix=/data/data/com.termux/files/usr' '--libdir=/data/data/com.termux/files/usr/lib' '--sbindir=/data/data/com.termux/files/usr/bin' '--disable-rpath' '--disable-rpath-hack' '--host=aarch64-linux-android' 'pgac_cv_prog_cc_ldflags__Wl___as_needed=yes' 'USE_UNNAMED_POSIX_SEMAPHORES=1' '--with-icu' '--with-libxml' '--with-openssl' '--with-uuid=e2fs' 'ZIC=/home/builder/.termux-build/postgresql/host-build/src/timezone/zic' '--disable-nls' '--enable-shared' '--enable-static' '--libexecdir=/data/data/com.termux/files/usr/libexec' 'host_alias=aarch64-linux-android' 'CC=aarch64-linux-android-clang' 'CFLAGS= -fstack-protector-strong -Oz' 'LDFLAGS=-L/data/data/com.termux/files/usr/lib -Wl,-rpath=/data/data/com.termux/files/usr/lib -fopenmp -static-openmp -Wl,--enable-new-dtags -Wl,--as-needed -Wl,-z,relro,-z,now' 'CPPFLAGS= -I/data/data/com.termux/files/usr/include' 'CXX=aarch64-linux-android-clang++' 'CXXFLAGS= -fstack-protector-strong -Oz' 'CPP=aarch64-linux-android-cpp' 'PKG_CONFIG=/home/builder/.termux-build/_cache/android-r25c-api-24-v2/bin/pkg-config' 'PKG_CONFIG_LIBDIR=/data/data/com.termux/files/usr/lib/pkgconfig:/data/data/com.termux/files/usr/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 15.2 on aarch64-unknown-linux-android, compiled by Android (9352603, based on r450784d1) clang version 14.0.7 (https://android.googlesource.com/toolchain/llvm-project 4c603efb0cca074e9238af8b4106c30add4418f6), 64-bit"
