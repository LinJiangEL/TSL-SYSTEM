...
#define LWS_INSTALL_DATADIR "/data/data/com.termux/files/usr/share"
#define LWS_INSTALL_LIBDIR "/data/data/com.termux/files/usr/lib"
#define LWS_LIBRARY_VERSION_MAJOR 4
#define LWS_LIBRARY_VERSION_MINOR 3
#define LWS_LIBRARY_VERSION_PATCH_ELABORATED 2-no_hash
...
#define LWS_LIBRARY_VERSION "4.3.2-no_hash"
